...
VL_ATTR_COLD void Vpong_top___024root___ctor_var_reset(Vpong_top___024root* vlSelf) {
    ...
    vlSelf->pong_top__DOT__text_unit__DOT__rom_addr = 0;
    ...
    vlSelf->pong_top__DOT__graph_unit__DOT__y_pad_reg = 0;
    vlSelf->pong_top__DOT__graph_unit__DOT__y_pad_next = 0;
    ...
    vlSelf->pong_top__DOT__graph_unit__DOT__pad_on = 0;
    vlSelf->pong_top__DOT__graph_unit__DOT__ball_on = 0;
    vlSelf->pong_top__DOT__graph_unit__DOT____VdfgExtracted_h6761e01b__0 = 0;
